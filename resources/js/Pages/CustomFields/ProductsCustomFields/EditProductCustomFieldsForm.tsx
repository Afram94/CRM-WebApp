...
interface EditProductCustomFieldsProps {
...
const EditProductCustomFieldsForm: React.FC<EditProductCustomFieldsProps> = ({ productCustomField, closeModal }) => {
  const [fieldName, setFieldName] = useState<string>(productCustomField.field_name);
  const [fieldType, setFieldType] = useState<string>(productCustomField.field_type);
  ...
  const updateCustomField = async () => {
    try {
      ...
      const response = await axios.put(`/product-custom-fields/${productCustomField.id}`, payload);
...
export default EditProductCustomFieldsForm;
